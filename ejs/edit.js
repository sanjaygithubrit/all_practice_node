...
app.get('/users', function (req, res) {
    ...
    con.query(`select option_tag_value from option_master where s_id = 10`, function (error, data) {
        if (error) throw error;
        data10 = data;
        res.render('edit.ejs', { data2, data3, data4, data5, data7, data8, data9, data10 })
    })
})
...
if(speak == undefined){
 ...
 con.query(`insert into language (id,l_lan,l_read,l_write,l_speak) values('${id}','${language1}','${read.includes(language1)?'Yes':'No'}','${write.includes(language1)?'Yes':'No'}','${speak.includes(language1)?'Yes':'No'}');`, function (error, data) {
            if (error) throw error;
            // console.log(data)
        })
}
...
if(tech_arry == true){
        ...
        con.query(`insert into technology (id,tech_name,rate) values("${id}","${tech_name}","${req.body[tech_name]}");`, function (error, data) {
            if (error) throw error;
...
app.get('/sanjay', function (req, res) {
    ...
    if (sanja == 1 || '') {
        con.query(`SELECT * FROM basic_information where isdelete = 0 ;`, function (error, data1, fields) {
            ...
            res.render("searchedit.ejs", { data: data1, sanja: '' });
        });
    }
    else {
...
app.get('/edit-api', function (req, res) {
    ...
    var data5;
    var data9;
    con.query(`SELECT * FROM preferance where id = ${edit};`, function (error, pref) {
        if (error) throw error;
        // console.log(pref);
        ...
        con.query(`select option_tag_value from option_master where s_id = 8`, function (error, data) {
            ...
            con.query(`select option_tag_value from option_master where s_id = 7`, function (error, data) {
                ...
                //  reference
                con.query(`SELECT * FROM reference where id = ${edit};`, function (error, refe) {
                    if (error) throw error;
                    // console.log(refe);
                    // technology
                    con.query(`select option_tag_value from option_master where s_id = 10`, function (error, data) {
                        ...
                        con.query(`SELECT * FROM technology where id = ${edit};`, function (error, tech) {
                            if (error) throw error;
                            // console.log(tech);
                            // language
                            con.query(`select option_tag_value from option_master where s_id = 9`, function (error, data) {
                                ...
                                con.query(`SELECT * FROM language where id = ${edit};`, function (error, lang) {
                                    if (error) throw error;
                                    // console.log(lang);

                                    con.query(`SELECT * FROM experience where id = ${edit};`, function (error, expe) {
                                        if (error) throw error;
                                        // console.log(expe);

                                        con.query(`SELECT * FROM education where id = ${edit};`, function (error, educ) {
                                            if (error) throw error;
                                            // console.log(educ);
                                            con.query(`select option_tag_value from option_master where s_id = 5`, function (error, data) {
                                                if (error) throw error;
                                                ...
                                                con.query(`select option_tag_value from option_master where s_id = 4`, function (error, data) {
                                                    ...
                                                    con.query(`select * from state; `, function (error, data) {
                                                        ...
                                                        con.query(`SELECT * FROM basic_information where id = ${edit};`, function (error, result) {
                                                            if (error) throw error;

                                                            console.log(result)
                                                            res.render("edit.ejs", { data3, data4, data5, data9, data10, data7, data8, result, educ, expe, lang, tech, refe,pref });
                                                        })
                                                    })
                                                })
                                            })
...
app.post('/update_edit',async function (req, res) {
...
// basic information
     ...
     con.query(`update basic_information set f_name = '${f_name}',l_name = '${l_name}',city = '${city}',state = '${state}',gender = '${gender}',dob = '${dob}',contact_no = '${contact_no}',address_1 = '${address_1}',address_2 = '${address_2}',relation = '${relation}',zip_code = '${zip_code}',designation = '${designation}',email = '${email}' where id = ${id_1};`, function (error, result) {
        if (error) throw error;
...
// education
    ...
    con.query(`DELETE FROM education where id = ${id_1};`, function (error, result) {
        if (error) throw error;
        // console.log("success delete")
        if (typeof degree == "string") {
            
            con.query(`insert into education (id,degree,passing_year,percentage) values('${id_1}','${degree}','${passing_year}','${percentage}');`, function (error, data) {
                if (error) throw error;
                // console.log(data)
                // console.log("success delete1")
            })
        }
        else {

            for (let j = 0; j < degree.length; j++) {
                con.query(`insert into education (id,degree,passing_year,percentage) values('${id_1}','${degree[j]}','${passing_year[j]}','${percentage[j]}');`, function (error, data) {
                    if (error) throw error;
                    // console.log(data)
                    // console.log("success delete3")
                })
            }
        }
        // console.log("success delete4")
    })

    // work experience

 con.query(`DELETE FROM experience where id = ${id_1};`, function (error, result) {
        if (error) throw error;
        // console.log("success delete")

        if (typeof company_name == "string") {
            con.query(`insert into experience (id,company_name,company_position,start_date,end_date) values('${id_1}','${company_name}','${company_position}','${start_date}','${end_date}');`, function (error, data) {
                if (error) throw error;
                // console.log(data)
            })
            ...
            for (let k = 0; k < company_name.length; k++) {
                con.query(`insert into experience (id,company_name,company_position,start_date,end_date) values('${id_1}','${company_name[k]}','${company_position[k]}','${start_date[k]}','${end_date[k]}');`, function (error, data) {
                    if (error) throw error;
                    // console.log(data)
                })
            }
    ...
    con.query(`DELETE FROM language where id = ${id_1};`, function (error, result) {
        if (error) throw error;
        // console.log("success delete language")
        ...
        if(speak == undefined){
            ...
            if(typeof language1 == "object"){
            for (let p = 0; p<language1.length; p++) {
                con.query(`insert into language (id,l_lan,l_read,l_write,l_speak) values('${id_1}','${language1[p]}','${read.includes(language1[p])?'Yes':'No'}','${write.includes(language1[p])?'Yes':'No'}','${speak.includes(language1[p])?'Yes':'No'}');`, function (error, data) {
                    if (error) throw error;
                    // console.log(data)
                })
            }
         ...
         con.query(`insert into language (id,l_lan,l_read,l_write,l_speak) values('${id_1}','${language1}','${read.includes(language1)?'Yes':'No'}','${write.includes(language1)?'Yes':'No'}','${speak.includes(language1)?'Yes':'No'}');`, function (error, data) {
                    if (error) throw error;
                    // console.log(data)
                })
        }
...
con.query(`DELETE FROM technology where id = ${id_1};`, function (error, result) {
    if (error) throw error;
    // console.log("success delete technology")
    if(tech_name == undefined){
        tech_name =[];
    ...
    if(tech_arry == true){
            for (let i = 0; i < tech_name.length; i++) {
                con.query(`insert into technology (id,tech_name,rate) values("${id_1}","${tech_name[i]}","${req.body[tech_name[i]]}");`, function (error, data) {
                    if (error) throw error;
    
                })
            }
        }else{
            con.query(`insert into technology (id,tech_name,rate) values("${id_1}","${tech_name}","${req.body[tech_name]}");`, function (error, data) {
                if (error) throw error;
...
// reference
con.query(`DELETE FROM reference where id = ${id_1};`, function (error, result) {
    if (error) throw error;
    // console.log("success delete reference")

    con.query(`insert into reference (id,name,contact_no,relation) values('${id_1}','${name1}','${contact_no1}','${relation1}'),('${id_1}','${name2}','${contact_no2}','${relation2}');`, function (error, data) {
        if (error) throw error;
    })
...
// preferance
con.query(`DELETE FROM preferance where id = ${id_1};`, function (error, result) {
    if (error) throw error;
    // console.log("success delete preferance")

    con.query(`insert into preferance (id,p_location,department,notice_p,c_ctc,e_ctc) values('${id_1}','${p_location}','${department}','${notice_p}','${c_ctc}','${e_ctc}');`, function (error, data) {
        if (error) throw error;
    })
