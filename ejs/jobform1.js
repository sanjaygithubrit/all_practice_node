...
app.get('/users', function (req, res) {
    ...
    con.query(`select option_tag_value from option_master where s_id = 10`, function (error, data) {
        if (error) throw error;
        data10 = data;
        res.render('form1.ejs', { data2, data3, data4, data5, data7, data8, data9, data10 })
    })
})
...
app.post('/form', function (req, res) {
    ...
    con.query(`insert into basic_information (f_name,l_name,city,state,gender,dob,contact_no,address_1,address_2,relation,zip_code,designation,email) values('${f_name}','${l_name}','${city}','${state}','${gender}','${dob}','${contact_no}','${address_1}','${address_2}',"${relation}",'${zip_code}','${designation}','${email}') ;`, function (error, data) {
        if (error) throw error;
        id = data.insertId;
